...
if not isfolder("MolaHub") then
    makefolder("MolaHub")
end
if not isfolder("MolaHub/Config") then
    makefolder("MolaHub/Config")
end
...
local ConfigFile = "MolaHub/Config/MOLA_" .. gameName .. ".json"
...
local Mola = {}
function Mola:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "Mola Hub"
    NotifyConfig.Description = NotifyConfig.Description or "Notification"
    NotifyConfig.Content = NotifyConfig.Content or "Content"
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(144, 212, 45)
...
function than(msg, delay, color, title, desc)
    return Mola:MakeNotify({
        Title = title or "Mola Hub",
        Description = desc or "Notification",
        Content = msg or "Content",
        Color = color or Color3.fromRGB(144, 212, 45),
        Delay = delay or 4
    })
end

function Mola:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "Mola Hub"
    GuiConfig.Footer       = GuiConfig.Footer or "Mola Hub :3"
    GuiConfig.Color        = GuiConfig.Color or Color3.fromRGB(144, 212, 45)
    ...
    local MolaGui = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    MolaGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    MolaGui.Name = "MolaGui"
    MolaGui.ResetOnSpawn = false
    MolaGui.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = MolaGui

    DropShadowHolder.Position = UDim2.new(0, (MolaGui.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (MolaGui.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("MolaGui") then
            MolaGui:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Gradient.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0, Color3.fromRGB(181, 230, 29)),
            ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(106, 190, 48)),
            ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(1.0, Color3.fromRGB(181, 230, 29))
        })
        ...
        Yes.MouseButton1Click:Connect(function()
            if MolaGui then MolaGui:Destroy() end
    ...
    UIStroke14.Color = Color3.fromRGB(144, 212, 45)
    UIStroke14.Thickness = 2.5
    UIStroke14.Transparency = 0.8
    UIStroke14.Parent = DropdownSelect

    DropdownSelectReal.AnchorPoint = Vector2.new(0.5, 0.5)
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(20, 60, 20)
